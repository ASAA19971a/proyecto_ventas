...
<body class="hold-transition sidebar-mini">
                ...
                <div class="contianer-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Información de Perfil</h3> <br>
                            <button class="btn btn-outline-primary" id="btnnuevo" onclick="nuevo()">
                                <i class="fa fa-plus-square mg-r-10"></i> Nuevo Registro</button>
                        </div>
                        <div class="card-body">
                            <table id="perfil_data" class="table display responsive nowrap">
                                <thead>
                                    <tr>
                                        <th class="wd-15p">Nombre Perfil</th>
                                        <th class="wd-15p"></th>
                                        <th class="wd-20p"></th>
                                    </tr>
                                </thead>
    ...
    <script src="adminmntperfil.js"></script>
</body>
